...
namespace PlanedBudgetPro.Controllers
{
    public class OrdermsController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            IPagedList<Customerm> OrderAndCustomerList = db.Customerms.OrderBy(c => c.ParentId).Where(c => c.ParentId == SITEID).ToPagedList(page ?? 1, 10);
        ...
        {
            IPagedList<Customerm> OrderAndCustomerList = db.Customerms.OrderBy(c => c.ParentId).ToPagedList(page ?? 1, 10);
            return View(OrderAndCustomerList);
        }
